...
[_QWERTY] = KEYMAP( \
  ...
  KC_LCTL, KC_LGUI, KC_LALT, TT(_LOWER), KC_LSFT, TT(_RAISE),   KC_SPC, KC_SPC,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
),
...
[_LOWER] = KEYMAP( \
  ...
  _______, _______, _______, _______, KC_LOCK, _______, _______, _______, KC_MPRV, KC_MSTP, KC_MPLY, KC_MNXT \
),
